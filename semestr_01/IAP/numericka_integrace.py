...
# a vysypu to do konzole
print("numerical solution: %s" % result)

# matematicky presny vysledek. cerna magie. Prostudujte si dokumentaci k modulu sympy
# hodi se i jupyter-qtconsole + QTcko + latex, pak to dela hezkej vypis
# ale je hromada patlani s instalaci
